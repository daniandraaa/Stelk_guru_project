              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text('B. Olahraga Warisan Budaya Bangsa', style: Theme.of(context).textTheme.bodyText2,),
                    const SizedBox(
                      height: 5,
                    ),
                    Padding(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: ElevatedButton(
                              ...
                              child:  SizedBox(
                                  width: 100, child: Text('kerjakan tugas', style: Theme.of(context).textTheme.bodyText2,)),
                            ),
                          ),
                        ],
                      ),
                    ...
                    const SizedBox(
                     ...
                     Text('C. Tugas 2: Kerja Kelompok', style: Theme.of(context).textTheme.bodyText2,)
                  ],
                ),
              )
            ],
